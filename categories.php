...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="css/jScrollHorizontalPane.css">
    <link rel="stylesheet" type="text/css" media="screen" href="css/style.css">
    <script type="text/javascript" src="js/jquery.js"></script>
    <script type="text/javascript" src="js/jquery-migrate-1.1.1.js"></script>
</head>
<body class="categories_page">
<!--==============================header=================================-->
...
<div class="main">
	<h2 class="title5">Рубрикатор</h2>
	<div class="filter">
	    <ul class="filter_list wrapper">
	        <li class="filter_it1">
	            <a href="#" class="filter_lk">Все номера</a>
	        </li>
	        <li class="filter_it">
	            <a href="#" class="filter_lk">2014</a>
	        </li>
	        <li class="filter_it">
	            <a href="#" class="filter_lk">2013</a>
	        </li>
	        <li class="filter_it">
	            <a href="#" class="filter_lk">2012</a>
	        </li>
	        <li class="filter_it activ">
	            <a href="#" class="filter_lk">2011</a>
	        </li>
	        <li class="filter_it">
	            <a href="#" class="filter_lk">2010</a>
	        </li>
	        <li class="filter_it">
	            <a href="#" class="filter_lk">2009</a>
	        </li>
	        <li class="filter_it">
	            <a href="#" class="filter_lk">2008</a>
	        </li>
	        <li class="filter_it">
	            <a href="#" class="filter_lk">2007</a>
	        </li>
	        <li class="filter_it">
	            <a href="#" class="filter_lk">2006</a>
	        </li>
	        <li class="filter_it">
	            <a href="#" class="filter_lk">2005</a>
	        </li>
	        <li class="filter_it">
	            <a href="#" class="filter_lk">2004</a>
	        </li>
	    </ul>
	</div>
	<div class="wrapper">
		<aside role="complementary" class="sidebar f_left">
        	<ul class="list6">
        		<li class="list6_it">
        			<a href="" class="list6_lk">Вопросы теории</a>
        		</li>
        		<li class="list6_it current">
        			<a href="" class="list6_lk">Инженерные решения</a>
        		</li>
        		<li class="list6_it">
        			<a href="" class="list6_lk">Инструменты и оборудование</a>
        		</li>
        		<li class="list6_it">
        			<a href="" class="list6_lk">Надежность и качество</a>
        		</li>
        		<li class="list6_it">
        			<a href="" class="list6_lk">Практическая электроника</a>
        		</li>
        		<li class="list6_it">
        			<a href="" class="list6_lk">Приборы и системы</a>
        		</li>
        		<li class="list6_it">
        			<a href="" class="list6_lk">Программирование</a>
        		</li>
        		<li class="list6_it">
        			<a href="" class="list6_lk">Проектирование и моделирование</a>
        		</li>
        		<li class="list6_it">
        			<a href="" class="list6_lk">Рынок</a>
        		</li>
        		<li class="list6_it">
        			<a href="" class="list6_lk">События</a>
        		</li>
        		<li class="list6_it">
        			<a href="" class="list6_lk">Современные технологии</a>
        		</li>
        		<li class="list6_it">
        			<a href="" class="list6_lk">Элементы и компоненты</a>
        		</li>
        	</ul>
        ...
        <section role="main" class="f_right">
        	<table class="journal_table">
                <tr>
                    <th class="cell_left"><h3 class="title3">№9 / 2011</h3></th>
                    <th class="cell_right"><a href="#" class="button1">Весь журнал</a></th>
                </tr>
                <tr>
                    <td class="cell_left">
                ...
                <tr>
                    <td class="cell_left">
                        ...
                        приручил коня. Затем в процессе эволюции 
                        появился гужевой транспорт. Позже табун лошадей 
                        «загнали» в двигатель внутреннего сгорания, 
                        сменив сено на бензин. Однако природные нефтяные 
                        ресурсы не бездонны, и требования сегодняшнего 
                        времени – альтернативная энергетика – возобновляемые 
                        источники энергии. Успехи в области технологий 
                ...
                <tr>
                    <td class="cell_left">
                        ...
                        исследований компания IHS Automotive публикует доклад, 
                        в котором прогнозируется рост совокупного числа станций, 
                        установленных по всему миру, более чем в 100 раз к 2020 
                ...
                <tr>
                    <td class="cell_left">
                        ...
                        разнообразные способы защиты информации, но 
                        любой из них вместе с преимуществами имеет 
                        недостатки. Поэтому необходимо постоянно 
                        совершенствовать методы защиты информации, 
            ...
            <table class="journal_table">
                <tr>
                    <th class="cell_left"><h3 class="title3">№7 / 2011</h3></th>
                    <th class="cell_right"><a href="#" class="button1">Весь журнал</a></th>
                </tr>
                <tr>
                    <td class="cell_left">
                ...
                <tr>
                    <td class="cell_left">
                        ...
                        STM32 от компании STMicroelectronics. 
                        Рассмотрена архитектура, состав и назначение 
                ...
                <tr>
                    <td class="cell_left">
                        ...
                        электропитания является создание 
                        специализированных функциональных узлов, 
            ...
            <table class="journal_table">
                <tr>
                    <th class="cell_left"><h3 class="title3">№6 / 2011</h3></th>
                    <th class="cell_right"><a href="#" class="button1">Весь журнал</a></th>
                </tr>
                <tr>
                    <td class="cell_left">
                ...
                <tr>
                    <td class="cell_left">
                        ...
                        питания и их параметров. В статье описана 
                        каждая из этих систем, обсуждены их 
                        приложения, перечислены преимущества 
                        и недостатки. Основываясь на этой информации, 
            ...
            <table class="journal_table">
                <tr>
                    <th class="cell_left"><h3 class="title3">№3 / 2011</h3></th>
                    <th class="cell_right"><a href="#" class="button1">Весь журнал</a></th>
                </tr>
                <tr>
                    <td class="cell_left">
                ...
                <tr>
                    <td class="cell_left">
                        ...
                        основе симистора MAC97A8 и неоновой лампы NE-2. 
                        Простота схемы и малые габариты компонентов 
            ...
            <table class="journal_table">
                <tr>
                    <th class="cell_left"><h3 class="title3">№1 / 2011</h3></th>
                    <th class="cell_right"><a href="#" class="button1">Весь журнал</a></th>
                </tr>
                <tr>
                    <td class="cell_left">
                ...
                <tr>
                    <td class="cell_left">
                        ...
                        была открыта уникальная экспозиция ВВС России, 
                        представленная лучшими предприятиями отрасли. 
                        Самыми эффектными лётными программами стали групповой 
                        пролёт российских истребителей пятого поколения ПАК ФА 
                ...
                <tr>
                    <td class="cell_left">
                        ...
                        Конкурс способствует росту общественной и 
                        политической значимости отечественной электронной 
                        отрасли, сохранению исторической преемственности 
                        поколений в научном сообществе. Цель премии – создание 
                        среды, поддерживающей передовые идеи, авторитет 
                        российской инженерной школы, процессы формирования 
